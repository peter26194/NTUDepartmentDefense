...
import com.example.ntudepartmentdefense.layer.ManagedLayer;
import com.example.ntudepartmentdefense.reference.OptionsLayer;
import com.example.ntudepartmentdefense.scene.GameScene;
import com.example.ntudepartmentdefense.scene.ManagedScene;
...
public class SceneManager extends Object
{
	...
	private IUpdateHandler mLoadingScreenHandler = new IUpdateHandler() {
		...
		public void onUpdate(float pSecondsElapsed) {
			...
			mNextScene.incrementLoading( pSecondsElapsed );
	...
	public void showScene(final ManagedScene pManagedScene) {
		...
		if(pManagedScene.hasLoadingScreen) {
			...
			pManagedScene.setChildScene(pManagedScene.onLoadingScreenLoadAndShown(),false,false,false);
	...
	public void showTitleScene() {
		if (mCurrentScene != TitleScene.getInstance())
		    showScene(TitleScene.getInstance());
	}
	...
	public void showGameScene() {
		...
		NetworkManager.getInstance().setGameScene(gScene);
		showScene( gScene );
	}
	...
	public void hideLayer() {
		if(isLayerShown) {
			currentLayer.onHideManagedLayer();
